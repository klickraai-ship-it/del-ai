 ...
 */
export function generateHMACSignature(data, secret = TRACKING_SECRET) {
 ...
 */
export function encodeToken(data, signature) {
 ...
 */
export function validateHMACSignature(data, signature, secret = TRACKING_SECRET) {
 ...
 */
export function setTrackingSecret(secret) {
 ...
 */
export function validateToken(token, secret = TRACKING_SECRET) {
 ...
 * @returns Base64url encoded token
 */
export function generateToken(dataFields, secret = TRACKING_SECRET) {
