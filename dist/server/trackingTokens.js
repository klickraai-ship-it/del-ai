 ...
 */
export function generateTrackingToken(campaignId, subscriberId) {
 ...
 * @returns HMAC-signed base64url token
 */
export function generateClickTrackingToken(campaignId, subscriberId, url) {
 ...
 */
export function decodeClickTrackingToken(token) {
    const validatedData = validateToken(token);
    if (!validatedData) {
        return null;
    }
 ...
 * @returns HMAC-signed base64url token
 */
export function generateUnsubscribeToken(subscriberId, userId) {
 ...
 * @returns HMAC-signed base64url token
 */
export function generateWebVersionToken(campaignId, subscriberId, userId) {
 ...
 */
export function decodeWebVersionToken(token) {
    const validatedData = validateToken(token);
    if (!validatedData) {
        return null;
    }
