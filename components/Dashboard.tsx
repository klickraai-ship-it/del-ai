...
const Dashboard: React.FC<DashboardProps> = ({ data }) => {
  ...
  return (
    <div className="space-y-6">
      {/* Action Bar */}
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-gradient-to-r from-gray-800 to-gray-900 p-4 rounded-xl border border-gray-700/50">
        ...
        <div className="flex items-center gap-2">
          <div className="flex items-center gap-2 bg-gray-700/50 rounded-lg p-1">
            <button
              ...
              className={`px-3 py-1.5 rounded text-xs font-medium transition-all min-h-[36px] ${
                selectedMetric === 'all' 
          ...
          <button
            ...
            disabled={refreshing}
            className="flex items-center gap-2 px-3 py-2 bg-gray-700 hover:bg-gray-600 text-white rounded-lg transition-all min-h-[36px] disabled:opacity-50"
          >
          ...
          <button
            ...
            className="flex items-center gap-2 px-3 py-2 bg-blue-600 hover:bg-blue-500 text-white rounded-lg transition-all min-h-[36px]"
          >
